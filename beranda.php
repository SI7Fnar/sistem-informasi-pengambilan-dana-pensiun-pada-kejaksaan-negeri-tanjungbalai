    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong><marquee bgcolor="brown", behavior="alternate", scrollamount="12">Selamat Datang di DATA PEGAWAI DPRD KOTA TANJUNGBALAI</marquee></strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-3 col-xs-12">
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title">Login Ke Sistem</h3>
                </div>
                <div class="panel-body">
